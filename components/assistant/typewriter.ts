...
/**
 * The "fields visibly fill in" effect — the task doc's highest-impact demo
 * moment. Opens the compose card and types the AI's draft into the fields
 * character-by-character, ~2 seconds total regardless of length.
 *
