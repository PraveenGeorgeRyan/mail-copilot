...
// ✏️ YOUR CONTRIBUTION POINT #2 — the assistant's standing orders.
// This is the most interview-relevant artifact in the app: it defines how
// the AI behaves. Read it, reword it, make it yours. Rules of thumb:
// tell the model WHEN to use which tool, and what it must never do.
